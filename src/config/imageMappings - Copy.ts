...
export const PRODUCT_IMAGE_MAP: Record<string, string> = {
  ...
  'kimchi-005': '/src/assets/images/products/kimchi/cucumber-kimchi.jpg',
  'kimchi-006': '/src/assets/images/products/kimchi/water-kimchi.jpg',
  'kimchi-007': '/src/assets/images/products/kimchi/spring-onion-kimchi.jpg',
  'kimchi-008': '/src/assets/images/products/kimchi/mustard-kimchi.jpg',
  'kimchi-009': '/src/assets/images/products/kimchi/wrapped-kimchi.jpg',
  'kimchi-010': '/src/assets/images/products/kimchi/nabak-kimchi.jpg',

  // Ramen images
  'ramen-001': '/src/assets/images/products/ramen/shin-ramyun.jpg',
  'ramen-002': '/src/assets/images/products/ramen/jin-ramyun.jpg',
  'ramen-003': '/src/assets/images/products/ramen/buldak-ramen.jpg',
  'ramen-004': '/src/assets/images/products/ramen/neoguri-ramen.jpg',
  'ramen-005': '/src/assets/images/products/ramen/bibim-men.jpg',
  'ramen-006': '/src/assets/images/products/ramen/ottogi-ramen.jpg',
  'ramen-007': '/src/assets/images/products/ramen/cheese-buldak-ramen.jpg',
  'ramen-008': '/src/assets/images/products/ramen/chapagetti.jpg',
  'ramen-009': '/src/assets/images/products/ramen/buldak-mild.jpg',

  // Sauces images
  'sauce-001': '/src/assets/images/products/sauces/gochujang.jpg',
  'sauce-002': '/src/assets/images/products/sauces/doenjang.jpg',
  'sauce-003': '/src/assets/images/products/sauces/ssamjang.jpg',
  'sauce-004': '/src/assets/images/products/sauces/soy-sauce.jpg',
  'sauce-005': '/src/assets/images/products/sauces/sesame-oil.jpg',
  'sauce-006': '/src/assets/images/products/sauces/gochugaru.jpg',
  'sauce-007': '/src/assets/images/products/sauces/bibimbap-sauce.jpg',
  'sauce-008': '/src/assets/images/products/sauces/bulgogi-marinade.jpg',
  'sauce-009': '/src/assets/images/products/sauces/yakult-gochujang.jpg',
  'sauce-010': '/src/assets/images/products/sauces/perilla-oil.jpg',
  ...
  'snack-003': '/src/assets/images/products/snacks/shrimp-crackers.jpg',
  'snack-004': '/src/assets/images/products/snacks/pepero.jpg',
  'snack-005': '/src/assets/images/products/snacks/cheetos.jpg',

  // Beverages images
  'beverage-001': '/src/assets/images/products/beverages/makkoli.jpg',
  'beverage-002': '/src/assets/images/products/beverages/soju.jpg',
  'beverage-003': '/src/assets/images/products/beverages/cass-beer.jpg',

  // Essentials images
  'essential-001': '/src/assets/images/products/essentials/rice-cake.jpg',
  'essential-002': '/src/assets/images/products/essentials/glass-noodles.jpg',
  'essential-003': '/src/assets/images/products/essentials/pancake-mix.jpg',

  // Seafood images
  'seafood-001': '/src/assets/images/products/seafood/anchovies.jpg',
  'seafood-002': '/src/assets/images/products/seafood/seaweed.jpg',
  'seafood-003': '/src/assets/images/products/seafood/dried-squid.jpg',

  // Grains images
  'grain-001': '/src/assets/images/products/grains/rice.jpg',
  'grain-002': '/src/assets/images/products/grains/mixed-grains.jpg',
  'grain-003': '/src/assets/images/products/grains/sweet-potato-noodles.jpg',

  // Frozen images
  'frozen-001': '/src/assets/images/products/frozen/dumplings.jpg',
  'frozen-002': '/src/assets/images/products/frozen/tteokbokki-set.jpg',
  'frozen-003': '/src/assets/images/products/frozen/pajeon.jpg',

  // Health images
  'health-001': '/src/assets/images/products/health/red-ginseng.jpg',
  'health-002': '/src/assets/images/products/health/barley-tea.jpg',
  'health-003': '/src/assets/images/products/health/omija-tea.jpg',

  // Desserts images
  'dessert-001': '/src/assets/images/products/desserts/songpyeon.jpg',
  'dessert-002': '/src/assets/images/products/desserts/hotteok-mix.jpg',
  'dessert-003': '/src/assets/images/products/desserts/patbingsoo.jpg',

  // Specialty images
  'specialty-001': '/src/assets/images/products/specialty/royal-cuisine.jpg',
  'specialty-002': '/src/assets/images/products/specialty/bbq-set.jpg',
  'specialty-003': '/src/assets/images/products/specialty/tea-ceremony.jpg'
};
...
export const getProductImage = (productId: string, category: string): string => {
  ...
  // Try to get default category image
  const defaultImage = DEFAULT_CATEGORY_IMAGES[category];
  if (defaultImage) {
    return defaultImage;
  }
